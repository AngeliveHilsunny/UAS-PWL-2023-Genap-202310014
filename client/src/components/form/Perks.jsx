export default function Perks({selected,onChange}) {
  ...
  return (
    <>
      <label className="border border-veryLightGray text-darkBlue text-sm py-3 px-6 flex rounded-full gap-2 items-center cursor-pointer dark:hover:text-blue peer-checked:border-blue hover:text-blue dark:peer-checked:text-blue peer-checked:text-gray hover:border-blue ">
        <input type="checkbox" checked={selected.includes('wifi')} name="wifi" onChange={handleCbClick} className="rounded-full"/>
