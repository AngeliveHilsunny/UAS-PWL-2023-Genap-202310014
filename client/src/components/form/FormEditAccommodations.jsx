...
import BottomTitle from "../bottomTitle/BottomTitle";

export default function FormEditAccommodations () {
    const {id} = useParams();
    ...
    return (
        <div className="bg-white pb-24">
            ...
            <div className="m-12 mx-20 mb-24">
                <div className="py-24 yx-28 bg-white rounded-3xl border  border-veryLightGray border-box font-abc">
                    <div className="mx-24 grid justify-items-start font-abc">
                        <Link to="/dashboard/places" className="inline-flex gap-2 text-blue py-2 px-4 rounded-full items-center border border-blue mb-6 text-left font-light text-xs hover:bg-blue hover:text-white duration-300">
                        ...
                        <div className="w-full font-abc">
                            <div className="title">
                                <h1 className="text-blue font-semibold text-2xl">Edit your accommodations</h1>
                            ...
                            <form onSubmit={savePlace} >
                                ...
                                <button className="bg-blue rounded-full py-3 w-full my-4 text-white font-medium text-lg mt-16 hover:border hover:border-blue hover:text-blue hover:bg-white duration-500">Publish</button>
                            </form>
                        </div>
                    </div>
                </div>
